...
rl.question('What do you think of Node.js? ', (answer, err) => {
  answers.push(answer);
  if(err) {
    console.log("err")
  }
        ...
        rl.question('Which meal is your favourite? ', (answer) => {
          ...
          rl.question('What\'s your favourite thing to eat for that meal? ', (answer) => {
            ...
            rl.question('Which sport is your absolute favourite? ', (answer) => {
              ...
              console.log(
                `My name is ${name} and I really like ${activity}! I listen to ${music} 
                while eating ${food} during ${meal} and playing ${sport}... and I think Node is ${node}!!`
              );
            });
          });
        });
